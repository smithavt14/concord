  ...
  Chinese: [
    {
      ...
      age: '18个月至5岁',
      photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/Early%20Years%20Music%20Program.jpg',
      description: '遵循搿艺音乐总监所制定的课程系统，我们的音乐启蒙课程给幼童提供一个良好的音乐环境，在他们小时候就播下音乐兴趣的种子。这个课程系统是为18个月至5岁的幼龄儿童所定制。孩子在这个年龄段如同一块海绵，可以很自然地吸收音乐，可被塑造培养成一位热爱音乐并拥有音乐灵感的孩子，所以音乐启蒙是极其重要的。孩子们一辈子只有一次的童年，充满音乐的童年是非常愉悦的！',
      route: '/programs#earlyYears'
    },
    {
      title: '集体课',
