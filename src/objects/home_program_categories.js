  ...
  Chinese: [
    {
      ...
      age: '18个月 - 5岁',
      photo: 'http://concord-assets.oss-cn-beijing.aliyuncs.com/home__little-notes-music-foundation.jpg',
      description: '我们的“⾳音乐启蒙课程计划“ 是按我们总结的设计的计划，给幼龄⼉儿童提供⼀一个良好的⾳音乐环境，在 他们⼩小时候就播下⾳音乐兴趣的种⼦子。这个课程计划是为18个⽉月⾄至5岁幼龄⼉儿童定制。幼龄孩⼦子在这个 年年龄段就如⼀一块海海绵，可以很⾃自然地吸收⾳音乐，可容易易被培养成⼀一位热爱⾳音，拥有乐感的孩⼦子，所 以⾳音乐启蒙是⾮非常有效的。孩⼦子们⼀一辈⼦子只有⼀一次的童年年，充满⾳音乐欢乐的童年年是更更愉快的! ',
      id: 0
    },
    {
      title: '集体课',
      age: '不限年龄', 
      photo: 'http://concord-assets.oss-cn-beijing.aliyuncs.com/home__group-classes-kids.jpg',
      description: '我们的集体课适合刚开始接触⾳音乐或想⼊入⻔门⼀一⻔门乐器器的幼龄孩⼦子。这些专⻔门针对幼龄孩⼦子的启蒙课程是为了了培养孩⼦子们的⾳音乐兴趣，拥有⾳音乐基础，学会通过⾳音乐和⾃自⼰己的感官进⾏行行连接。 ',
      id: 1
    },
    {
      title: '兴趣素养的额外课程',
      age: '不限年龄',
      photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/experience__drums.jpg',
      description: '下课程是在已有乐器器组课或⼀一对⼀一⾳音乐课程的基础上，额外拓拓展的⾳音乐素养课程。这些课程主要⽤用于辅助主课，是有必要同时进⾏行行的。这些课程将提⾼高学⽣生的⾳音乐素养，扩⼤大学⽣生对⾳音乐知识层⾯面 的认知，提⾼高他们对⾳音乐的理理解。',
      id: 3
    },
    {
      title: '乐器基础课 | 一对一专业课',
      age: '不限年龄',
      photo: 'http://concord-assets.oss-cn-beijing.aliyuncs.com/experience__fei-teaching.jpg',
      description: '我们的专业⼀一对⼀一课适于那些想接受系统化乐器器训练的学⽣生，并拥有稳固的兴趣去接受这样的训 练。搿艺⼀一对⼀一课的⽼老老师毕业于著名的⾳音乐学院，拥有⼀一定的经验去帮助不不同⽔水平的孩⼦子去创造成 就。⼀一对⼀一课提供师⽣生⼀一个最直接的互动环境。⽼老老师可按照不不同学⽣生的兴趣⽅方向，性格和⽬目标去定 制适合每位学⽣生的学习计划。',
      id: 2
    }
  ]
}
