  ...
  Chinese: {
    earlyYears: [
      ...
      }, 
      {
        title: '“小小音符” 音乐启蒙课',
        age: '3岁 - 4岁半',
        description: '小小音符音乐启蒙课程为3-4岁的孩子打开音乐之殿的大门，激发幼孩的音乐兴趣，作为1对1乐器课程前的铺垫和启蒙，让孩子以快乐的方式开始他们的音乐兴趣。课程内，孩子将探索接触不同的乐器，给予孩子有机会感受不同乐器的声音和乐趣，最终让孩子们为自己接下去的兴趣方向做决定。同时老师也会引导孩子通过打击乐器、歌唱和游戏方式探索音乐基础和知识如：声音探索、听力训练、节奏练习、乐理基础、乐器探索和古典音乐赏析。',
        photo: 'http://concord-assets.oss-cn-beijing.aliyuncs.com/home__group-classes-kids.jpg'
      },
      {
        title: '“小小音符” +',
    ...
    group: [
      ...
      },
      {
        title: '1对4小提琴课',
        age: '4岁 - 6岁',
        description: '孩子们将在外教的指导下，沿用创新的西方教学方法和教材学习小提琴的基本基础。课程包括阅读、基本技术和乐理知识。通过合奏和集体学习带来的动力，本课程是初学者的完美开始！同时也将提供表演机会，以增加学生的自信心。课程采用英皇出版社的英式教材，结合老师所挑选的其辅助教材。在完成这个课程后，学生将拥有充足的兴趣和信心去开始一对一课。',
        photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/apply__student-violen-teacher.jpg'
      }, 
      {
        title: '尤克里里集体课',
        age: '4岁 - 6岁',
        description: '尤克里里是个即好玩又轻松的乐器，轻便携带，容易上手！课程可作为一对一吉他或尤克里里课前的启蒙。学生将通过和老师、朋友的互动学习视谱、唱和拨弦技巧、乐理、节奏训练及合奏。课程氛围轻松愉快，通过好听的曲子掌握学习基础。',
        photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/about__banner.jpg'
      },
      {
        title: '1对2乐器课程',
        age: '4岁 - 5岁',
        description: '如果您想让孩子以较轻松的方式开始一个乐器的学习，不妨尝试一对二学习，尤其对幼龄孩子特别有效（3岁半-5岁）。年龄相近的兄弟姐妹或是朋友可以通过游戏和合奏的方式，让学习的氛围更为轻松愉快。通过互相分享，孩子的学习也更有动力。这也可以作为亲子乐器课，与您的孩子一同学习一门乐器！\n\n一对二乐器课程：钢琴、小提琴、尤克里里、吉他、歌唱 ',
        photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/experience__annie-violen.jpg'
      }
    ],
    supplemental: [
