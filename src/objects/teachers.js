const teachers = {
  English: [
    ...
    },
    {
      ...
      bio: 'Doyeon Diane Kim, a native of South Korea, has made her way across the globe with performances as a soloist and chamber musician at diverse festivals and music venues in United State, Europe, and Asia. She was also invited as an artist for guest artist series and exchange artist series during her studies and performed in top music school in the States such as Eastman School of Music, Cincinnati Conservatory of Music and Oberlin Conservatory of Music. In 2010, she made a debut in NYC with New York Concerti Symphonietta as a concerto soloist and also as a solo pianist at Carnegie Weill Hall.'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      bio: 'Annie started piano at the age of five with Professor Hong Huang and made it into Shanghai Conservatory of Music in year 2004. She was a double major in Music Education and Piano Performance. She continued his studies with Professor Hong Huang throughout her undergraduate studies. Annie has taught piano at Shanghai Ping He Bilingual School and she was also the Teaching Assistant at Zhang Xiao Feng Music Center where she helped students to prepare for precollege studies of music conservatories. Annie moved back to Shanghai and started teaching at Yamaha. She was a trained and certified yamaha teacher to teach music foundation group classes and piano foundation group classes. She taught as a trained and approved 1-on-1 instructor at Yamaha for 2 years.',
    },
    {
      id: 5,
      ...
      name: 'Gavin',
      role: 'Piano Instructor',
      bio: 'Gavin comes from Ahyrshire in Scotland, nationality is United Kingdom. He began his musical education at age of five, initially studying keyboard and later piano before going on to study music at Edinburg Napier University and B.C.U Birmingham Conservatoire. After graduating with a graduate degree from Birminghan Conservatorie, he worked as a pianist, accompanist and teacher in and around Ayrshire. He was also trained in the renewed Yamaha method and began teaching at a local yamaha music school. In September 2013, he was hired as a piano teacher at Academy of Performing Arts at the British School of Bahrain. He is now a full-time piano and group class instructor at Concord Music. Gavin’s aim is to empower students with the skills and knowledge they need in order to become independent learners. He believes it is through experiencing musical elements in a creative way that we truly develop our understanding.'
    },
    {
      id: 10,
    ...
    },
    {
      ...
      bio: 'Travis Lu has established himself as a jazz guitarist and is active in performing in Shanghai. He has appeared frequently in JZ Club, Wooden Box and 696 Bar. Travis has taken masterclasses with Legendary bassist and two-time Grammy ® award winner Eddie Gomez, jazz alto saxophonist Antonio Hart, jazz pianist Stefan Karlsson, jazz guitarist Sheryl Bailey, and jazz guitarist Ola Bengtsson, Travis started studying piano and voice when he was a child and later learned saxophone and jazz drums. He now focuses on jazz guitar performance and improvisation and works with many of the central figures in the growing jazz scene in China.'
    },
    {
      id: 14,
      ...
      name: 'Victor Noskov',
      role: 'Drums Instructor',
      bio: 'Viktor, an ukrainian drummer, graduated from the National University of Culture and Arts in Kiev (Ukraine) and has earned a Master degree in Percussion and Drums Performing with teaching certificate. He is also the co-founder of several percussion and drums projects and group such a modern drumming group “Fire Beat” and an ethnical percussion project “Mama-Africana”.'
    },
    {
      id: 15,
      photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/Yong-Wei%20Ho.jpeg',
      name: 'Yong-Wei Ho',
      role: 'Violin Instructor',
      bio: 'Yong-Wei Ho received his Associate of Trinity College of London (ATCL) violin in 2005, Licentiate of Trinity College of London (LTCL) for in violin performance with distinction and Licentiate of Trinity College of London (LTCL) in viola performance in 2009—also with distinction. From 2010 to 2011, Ho was a regular member at the Malaysian Philharmonic Youth Orchestra (MPYO). He received his Bachelor of Music and Master in Music at Tunghai University (Taichung, Taiwan) at 2017. During his studies, he studied viola performance with Professors Yih-Chyuan Wang. Ho also served as the teaching assistant in various music history and music theory courses. During his music studies at Tunghai University, Ho played in various master classes, including those taught by professors Dao-Chang Yu ,Allie Su, Hausmann Quartet and Sayaka Kobuko. During summer 2017, Ho was invited to perform with Formosa Philharmonic Orchestra (Taiwan) in Les Rencontres Musicales de Chaon at France. In 2017, he was selected as a member of Thailand Philharmonic Orchestra.  '
    },
    {
      id: 7,
      photo: 'https://concord-assets.oss-cn-beijing.aliyuncs.com/Beely.png',
      name: 'Beely Lee', 
