...
<template>
  <div class="wrapper">
    ...
    <b-modal v-model="modal.success" centered hide-header hide-footer>
      ...
      <div class="modal-title">{{translation.success}}</div>
      <div class="modal-diretions">{{translation.success_description}}</div>
      <div class="apply__bottom-banner-link orange modal-btn" @click="closeModal">{{translation.success_btn}}</div>
    </b-modal>
    ...
    <b-modal v-model="modal.error" centered hide-header hide-footer>
      ...
      <div class="modal-title">{{translation.error}}</div>
      <div class="modal-diretions">{{translation.error_description}}</div>
      <div class="apply__bottom-banner-link modal-btn cancel" @click="closeModal">{{translation.error_btn}}</div>
    </b-modal>
  </div>
</template>
