const about = {
  ...
  Chinese: {
    ...
    OPsubtitle: '理念',
    OPtitle: '搿艺音乐的理念',
    OPcontent: '搿艺音乐坐落于古北/虹桥地区，在国际化的氛围中提供高水平的音乐教育，鼓励各年龄层的学生发展对音乐的兴趣。\n \n 搿艺的师资团队由一流的各国音乐家们组成。他们毕业于世界上最负盛名的音乐学院，为沪上社区带来具创新性的教学体验。\n \n 我们的理念是以创新的教学方法，结合西式教学方式将古典音乐的传统适应于二十一世纪。搿艺成立已有6年之久，其以“培养音乐兴趣”的理念被公众所认可。 ',
    mapTitle: '我们地址',
    reasonsTitle: '选择搿艺的5个理由',
    OPAsubtitle: '合作伙伴',
    OPAtitle: '为我们的合作伙伴提供高质量水准的音乐教育',
    OPAcontent: '搿艺音乐与国际教育机构进行合作，经验丰富，长期为他们提供一对一的乐器课程和课后音乐课程。与搿艺进行长期进行音乐课程合作的学校有：\n \n - 上海不列颠英国外籍人员子女学校 \n - 上海协和双语学校 \n - 小小萌树 \n - 悦童小院 \n \n 搿艺已有多年经验帮助其他教育机构和学校构建专业的音乐教育教学体系，并保证质量。根据不同的需求和兴趣，我们还能够个性化我们的课程项目，以适应您的学校理念和愿景。如果您有兴趣与搿艺进行合作，请联系我们。'
  }
}
