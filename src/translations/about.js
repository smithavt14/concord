const about = {
  English: {
    ...
    OPcontent: "Concord Music offers professional music instruction in an international ambiance, located in Shang- hai. We strive to provide a high level of music education that encourages students of all ages and levels to develop their interest in music. \n\nOur faculty consists of world-class musicians who have graduated from the world's most prestigious conservatories and are able to bring in their Western teaching expertise for the benefit of the Shanghai community. \n\n Our philosophy is to adapt the heritage of classical music to the 21st century by using innovative teaching methods. Concord has been around for 7 years by now and is recognized for being firm of its philosophy to cultivate music interest as a life-long interest.",
  ...
  Chinese: {
    ...
    OPsubtitle: '理念',
    OPtitle: '搿艺音乐的理念',
    OPcontent: '搿艺音乐的理念 搿艺音乐坐落于上海，在国际化的氛围中提供高水准的音乐教育，鼓励各年龄层的学生发展对音乐的 兴趣。搿艺的师资团队由世界各地一流的音乐家们组成。他们毕业于世界上最负盛名的音乐学院，为 沪上社区带来具有创新性的教学体验。我们的理念是以创新的教学方法，结合⻄式教学方式将古典音 乐的传统适应于二十一世纪。搿艺成立已有7年之久，其以“培养音乐兴趣”的理念被公众所认可。',
    mapTitle: '地理位置',
