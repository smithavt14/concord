const programs = {
  ...
  Chinese: {
    programs: '课程',
    calendar: '日历',
    earlyYearsPrograms: '音乐启蒙课程计划',
    earlyYearsProgramsContent: '我们的“音乐启蒙课程计划“ 是按我们总结的设计的计划，给幼龄儿童提供一个良好的音乐环境，在他们小时候就播下音乐兴趣的种子。这个课程计划是为18个月至5岁幼龄儿童定制。幼龄孩子在这个年龄段就如一块海绵，可以很自然地吸收音乐，可容易被培养成一位热爱音，拥有乐感的孩子，所以音乐启蒙是非常有效的。孩子们一辈子只有一次的童年，充满音乐欢乐的童年是更愉快的！',
    summary: '介绍',
    ...
    privateLessonsRateDescription: '我们的学费是按上课分钟而定。由于每位学生的专注力和学习情况不同，如想知道上课分钟多少最为合适，请和我们联系安排一节课试上后，老师将提供专业建议。',
    age1: '7岁或以下／零基础',
    age2: '8岁或以上 ／有基础',
    age3: '中级或高级学生',
    minutes1: '30分钟',
