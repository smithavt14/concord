const programs = {
  English: {
    ...
    earlyYearsProgramsContent: 'Our Early Years Music Program follows a systematic syllabus created by Concord director with the aim to cultivate music interest from early ages. Our program offers variety of fun courses for specific age groups of 18 months up to age 5. Children absorb information like a sponge at their early age which makes musicality and music foundations possible to be cultivated naturally at these ages. Childhood is precious for it is only once in a lifetime and it is even more memorable with music in it!',
    summary: 'SUMMARY',
    ...
    ourProgramsContent: 'Concord tailor our programs to meet different needs and interests, while provided a well rounded learning experience for all. We also offer students different modes of learning: 1-on-1, 1-on-2, 1-on-4 and group setting. Our step-by-step programs allow students to take one step a time while we work on the big picture to keep your interest going steadily!',
    ...
    schoolCalendar: 'Click here to see our school calendar'
  },
  Chinese: {
    programs: '课程',
    calendar: '日历',
    earlyYearsPrograms: '音乐启蒙课程',
    earlyYearsProgramsContent: '遵循搿艺音乐总监所定制的课程系统，我们的音乐启蒙课程给幼童提供一个良好的音乐环境，在他们小时候就播下音乐兴趣的种子。这个课程系统是为18个月至5岁的幼龄儿童所定制。孩子在这个年龄段就如一块海绵，可以很自然地吸收音乐，可被塑造培养成一位热爱音乐并拥有音乐灵感的孩子，所以音乐启蒙是极其重要的。孩子们一辈子只有一次的童年，充满音乐的童年是非常愉悦的！',
    summary: '介绍',
    privateLessons: '一对一专业课',
    groupLessons: '集体课',
    camps: '',
    calendarTitle: '日历',
    signup: '申请',
    ...
    privateLessonsRateTitle: '费用 ／ 上课时长',
    privateLessonsRateDescription: '我们的学费是按上课时长而定。由于每位学生的专注力和学习情况不同，如想知道上课时长多少最为合适，请和我们联系安排一节课试上后，老师将提供专业建议。我们一般会建议：',
    age1: '7岁或以下／零基础',
    age2: '8岁或以上 ／有基础',
    age3: '中级或高级学生',
    minutes1: '30分钟',
    ...
    minutes3: '60分钟',
    groupTitle: '团课',
    groupDescription: '集体课为孩子提供合奏与互动的机会，这不仅促进沟通，还能增强孩子们的领导能力、纪律、分享及合作精神。搿艺集体课的教学方法是通过刺激孩子不同的感官（语音，视觉，听觉和律动）去提高他们对音乐的兴趣、认知和欣赏。对于年龄较小，如2至4岁的孩子，集体音乐课是一个很好的启蒙，为后期的一对一课程做好准备。\n\n 我们集体课的亮点：\n\n * 4-6名学生的小组高质量学习 \n * 专业教师以西式教育培养孩子们的音乐兴趣 \n * 双语或全英文的学习环境 \n * 好玩，有趣，不枯燥！',
